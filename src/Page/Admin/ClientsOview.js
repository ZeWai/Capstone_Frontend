...
export const ClientsOview = () => {
    ...
    const submitNewAssign = () => {
        ...
        axios.delete(`${process.env.REACT_APP_API_SERVER}/api/resetAssign`, { data: newAssignForm })
            .then((res) => {
                setModal(false);
                //reload client list
                dispatch(GetClientListThunk());
        ...
        <>
            ...
            <Modal className="admin-popup-wrapper" show={modal}>
                ...
                <Modal.Footer className="admin-popup-footer">
                    <Button className='admin-popup-submit-btn' onClick={submitNewAssign} name={CurrentClient} >Submit</Button>
                    <Button className='admin-popup-cancel-btn' onClick={() => setModal(false)} name={CurrentClient}>Cancel</Button>
                </Modal.Footer>
            </Modal >
        </>
    )
